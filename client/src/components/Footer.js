  ...
  render() {
    return (
      <footer className="footer d-flex flex-row flex-wrap align-items-center p-2">
        <p className="col-12 col-sm-5 text-center m-0">Made by Rishav Agarwal</p>

        {/* Github and social media handles */}
        <div className="d-flex justify-content-center col-12 col-sm-7 w-50">
          ...
          <OverlayTrigger overlay={<Tooltip>Github</Tooltip>}>
            ...
            <a href="https://github.com/Rishav-Agarwal" target="_blank" rel="noreferrer noopener">
          ...
          <OverlayTrigger overlay={<Tooltip>Twitter</Tooltip>}>
            <a href="https://twitter.com/MrRedible" target="_blank" rel="noreferrer noopener">
          ...
          <OverlayTrigger overlay={<Tooltip>Linkedin</Tooltip>}>
            <a href="https://www.linkedin.com/in/rish-av/" target="_blank" rel="noreferrer noopener">
          ...
          <OverlayTrigger overlay={<Tooltip>Facebook</Tooltip>}>
            <a href="https://www.facebook.com/rishav.agarwal97" target="_blank" rel="noreferrer noopener">
